...
//  מאתר סטטי שמעביר /api הלאה, יש קפיצה נוספת — ואז TRUST_PROXY=2. ערך
//  קטן מדי מזהה את ה-CDN כלקוח ומאחד את כל המשתמשים לדלי אחד של הגבלת
//  קצב; ערך גדול מדי מאפשר לזייף כתובת. חייב להתאים לפריסה בפועל.
